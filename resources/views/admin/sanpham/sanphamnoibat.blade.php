                    ...
                    <div class="form-body">
                        <div class="alert alert-danger display-hide">
                            ...
                            <div class="col-md-8">
                                  ...
                                  <div class="form-group margin-top-20">
                                       <label class="control-label col-md-4">Loại sản phẩm nổi bật
                                         <span class="required"> * </span>
                                       </label>
                                <div class="col-md-8">
                                        <select class="form-control" id="id_loainoibat" name="id_loainoibat" style="width:100%;">
                                                 @foreach($loainoibat as $tl)
                                               <option value="{{$tl->id}}" id="id_sp">{{$tl->ten}}</option>
                                                   @endforeach
                                        </select>
                                    </div>
                                  </div>
